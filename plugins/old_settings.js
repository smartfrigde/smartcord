...
// to delete outdated and no longer maintaned
const edSettingsID = require("path").parse(__filename).name;

module.exports = new Plugin({
	name: 'Outdated SC settings (React)',
	author: 'jakuski#9191 and smartfridge#5834',
	description: 'Old version. Use at your own risk!.',
	color: 'darkred',
	async load () {
		...
		*/	
		return [{
			...
			element: () => {
				...
				return EDApi.React.createElement("div", { className: join(header, "ed-settings") }, "SmartCord")
			}
		},{
			section: "ED/Plugins",
			label: "Plugins",
	...
	_initReactComponents () {
		...
		const PluginsPage = () => {
			return e(FormSection, {title: "SmartCord Plugins", tag: "h2"},
					e(Flex, {},
						e(OpenPluginDirBtn)
					),
		...
		const SettingsPage = () => {
			return e(Fragment, null,
				e(FormSection, {title: "SmartCord Settings", tag: "h2"},
					e(BDPluginToggle),
					Object
						.keys(ED.plugins)
		...
		const BDPluginToggle = () => {
			...
			return e(SwitchItem, {
				...
				value: enabled,
				hideBorder: true,
				note: "Allows SmartCord to load BetterDiscord plugins natively. Reload (ctrl+r) for changes to take effect."
			},
