...
class BrowserWindow extends electron.BrowserWindow {
  constructor(originalOptions) {
    ...
    if (
      ...
      return win; // eslint-disable-line constructor-super
...
if (electron.deprecate && electron.deprecate.promisify) {
  ...
  electron.deprecate.promisify = (originalFunction) =>
    originalFunction ? originalDeprecate(originalFunction) : () => void 0; // Override with falsey check
}
